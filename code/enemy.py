...
class Enemy(Entity):
  def __init__(self,monster_name,pos, groups, obstacle_sprites, damage_player, trigger_death_particles, add_exp):
    ...
    # health bar
    self.health_bar = EnemyHealth(self.rect)
  ...
  def enemy_update(self, player):
    ...
    self.actions(player)
    monster_info = monster_data[self.monster_name]
    self.health_bar.display(player, self.rect.center, self.health, monster_info['health'])
...
class EnemyHealth():
  def __init__(self, enemy_rect):
    ...
    # general setup
    self.bg_rect = pygame.Rect(enemy_rect.left, enemy_rect.top, TILESIZE*0.9, 10)

  def display(self, player, pos, value, max_value):
